...
public interface IListDao {
	...
	List<ProductApprovalDto> getApproval(@Param("product_id") Long product_id);
	void updateApproval(@Param("product_id") Long product_id, @Param("status")String status, @Param("admin_id") String admin_id);
	void rejectApproval(@Param("product_id") Long product_id, @Param("status")String status, @Param("admin_id") String admin_id, @Param("rej_reason") String rej_reason);
	...
	void updateUser(@Param("user_id") Long user_id, @Param("password") String password, @Param("status") String status, @Param("name") String name, @Param("phone") String phone, @Param("birth") String birth, @Param("email") String email, @Param("gender") String gender, @Param("e_name") String e_name, @Param("postal_code") String postal_code, @Param("address") String address, @Param("address_detail") String address_detail);
	...
	List<SuggestedSearchDto> getPersonalSuggestKeywords();
	int deletePersonalSuggestKeyword();
