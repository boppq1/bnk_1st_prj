...
//		
//		if(uri.startsWith("/css") || uri.startsWith("/js") || uri.startsWith("/images") || uri.startsWith("/.well-known") || uri.startsWith("/api") || uri.startsWith("/error")) {
...
//				System.out.println("0.2초 간격 요청 발생");
//				applyPenalty(clientKey, 5); // 벌점 2점
...
//			System.out.println("차단된 검색어 검색 시도");
